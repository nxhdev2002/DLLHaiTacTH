public class NPC : MainObject
{
	...
	private void paintNpcEvent(mGraphics g)
	{
		if (typeNpcEvent == 1)
		{
			AvMain.fraEventMoon.drawFrameNew(0 + hardCodeEventMoon[indexEventMoon][3] * 3, x + hardCodeEventMoon[indexEventMoon][1], y + hardCodeEventMoon[indexEventMoon][2] - 3 + (fMyRandom + GameCanvas.gameTick / 7) % 2 * hardCodeEventMoon[indexEventMoon][4], 0, mGraphics.TOP | mGraphics.RIGHT, g);
		}
		if (typeNpcEvent == 2)
		{
