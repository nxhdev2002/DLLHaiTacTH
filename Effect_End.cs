		...
		try
		{
			...
			case 6:
				if (typeSub == 3)
				{
					...
					{
						Point point32 = (Point)VecEff.elementAt(num37);
						fraImgSub2Eff.drawFrameNew(indexEff_1 * fraImgEff.maxNumFrame + point32.f % fraImgEff.maxNumFrame, point32.x / 100, point32.y / 100, 0, 3, g);
					}
				}
			...
			case 11:
			{
				for (int num28 = 0; num28 < VecEff.size(); num28++)
				{
					...
					point25.fraImgEff.drawFrame(point25.f / numNextFrame % point25.fraImgEff.nFrame, point25.x, point25.y, 0, 3, g);
				}
				break;
			}
			case 47:
			{
				...
				{
					Point point9 = (Point)VecEff.elementAt(num2);
					fraImgEff.drawFrame(point9.f / numNextFrame % fraImgEff.nFrame, point9.x, point9.y, 0, 3, g);
				}
				break;
			}
			case 13:
				if (fraImgSubEff != null)
				{
					...
					{
						Point point29 = (Point)VecEff.elementAt(num33);
						fraImgSubEff.drawFrame(point29.f % fraImgSubEff.nFrame, point29.x, point29.y, Dir, 3, g);
					}
				}
				if (f <= fRemove)
				{
			...
			case 21:
			{
				...
				{
					Point point38 = (Point)VecEff.elementAt(num47);
					fraImgEff.drawFrame(point38.frame, point38.x, point38.y, 0, 3, g);
				}
				if (f < 6)
				{
			...
			case 22:
			{
				for (int num19 = 0; num19 < VecEff.size(); num19++)
				{
					...
					fraImgSubEff.drawFrame(point20.f / numNextFrame % fraImgSubEff.nFrame, point20.x, point20.y, Dir, 3, g);
				}
				if (isUpdateNormal)
				{
					fraImgEff.drawFrame(f / numNextFrame % fraImgEff.nFrame, x, y, Dir, 3, g);
			...
			case 23:
			{
				...
				{
					Point point13 = (Point)VecEff.elementAt(num6);
			...
			case 27:
				if (f <= fRemove)
				{
					...
					fraImgEff.drawFrame(num21, x, y, Dir, 3, g);
				}
				if (typeSub == 2)
				{
					for (int num22 = 0; num22 < VecEff.size(); num22++)
					{
						...
						fraImgSubEff.drawFrame(point21.f % fraImgSubEff.nFrame, point21.x, point21.y, Dir, 3, g);
					}
				}
				break;
			case 29:
			{
				...
				{
					Point point45 = (Point)VecEff.elementAt(num55);
			...
			case 30:
			{
				...
				{
					Line line2 = (Line)VecEff.elementAt(num49);
					if (line2 != null)
					{
						int color2 = 0;
						if (num49 / 2 < colorpaint.Length)
						{
							color2 = colorpaint[num49 / 2];
						}
						g.setColor(color2);
			...
			case 25:
				...
				if (typeSub == 2)
				{
					...
					{
						Point point28 = (Point)VecEff.elementAt(num32);
						fraImgSub2Eff.drawFrame(point28.f % fraImgSub2Eff.nFrame, point28.x, point28.y, Dir, 3, g);
					}
				}
				break;
			case 35:
			...
			case 37:
			{
				...
				{
					Point point49 = (Point)VecEff.elementAt(num60);
					fraImgSub2Eff.drawFrame(point49.f % fraImgSub2Eff.nFrame, point49.x, point49.y, Dir, 3, g);
				}
				if (f >= 0 && f < 6)
				{
					fraImgEff.drawFrame(f / 2, x1000, y1000, Dir, 3, g);
				...
				if (f < fRemove && f > 1)
				{
					...
					fraImgSubEff.drawFrame(num61, x, y, Dir, 3, g);
				}
				break;
			}
			case 38:
			...
			case 138:
			{
				for (int num50 = 0; num50 < VecEff.size(); num50++)
				{
					...
					fraImgEff.drawFrameNew(point40.frame * 4 + point40.f % fraImgEff.nFrame, point40.x, point40.y, Dir, 3, g);
				}
				break;
			}
			case 39:
			{
				...
				if (num43 > 2)
				{
					num43 = 2 + CRes.random(2);
				}
				fraImgEff.drawFrame(num43, x, y, Dir, 3, g);
				break;
			}
			case 40:
				if (f % 2 == 0)
			...
			case 120:
			{
				...
				{
					Point point15 = (Point)VecEff.elementAt(num8);
					if (point15.frame < 2)
					{
						fraImgSubEff.drawFrameNew(point15.fSmall * fraImgSubEff.maxNumFrame + point15.f / 2 % fraImgSubEff.maxNumFrame, point15.x, point15.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrameNew(point15.fSmall * fraImgSub2Eff.maxNumFrame + point15.f / 2 % fraImgSub2Eff.maxNumFrame, point15.x, point15.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 50:
			{
				...
				{
					Point point46 = (Point)VecEff.elementAt(num56);
					if (point46.frame < 2)
					{
						fraImgSubEff.drawFrame(point46.f / 2 % fraImgSubEff.nFrame, point46.x, point46.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrame(point46.f / 2 % fraImgSubEff.nFrame, point46.x, point46.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 54:
			{
				...
				{
					Point point36 = (Point)VecEff.elementAt(num44);
					if (typeSub == 1 || typeSub == 3 || typeSub == 10 || typeSub == 11 || typeSub == 12)
					{
						fraImgEff.drawFrame(3, point36.x, point36.y, Dir, 3, g);
					}
					else if (typeSub >= 4 && typeSub <= 7)
					{
						fraImgEff.drawFrameNew(frame * fraImgEff.maxNumFrame + point36.f % fraImgEff.maxNumFrame, point36.x, point36.y, Dir, 3, g);
					}
					else if (typeSub == 8)
					{
						fraImgEff.drawFrameNew((2 + num44 % 2) * fraImgEff.maxNumFrame + point36.f % fraImgEff.maxNumFrame, point36.x, point36.y, Dir, 3, g);
					}
					else if (typeSub == 9)
					{
						fraImgEff.drawFrameNew((frame + num44 % 2) * fraImgEff.maxNumFrame + point36.f % fraImgEff.maxNumFrame, point36.x, point36.y, Dir, 3, g);
					}
					else
					{
						fraImgEff.drawFrame(point36.f % fraImgEff.nFrame, point36.x, point36.y, Dir, 3, g);
					}
				}
				if (fraImgSubEff != null)
				{
					...
					{
						Point point37 = (Point)vecSubEff.elementAt(num45);
						fraImgSubEff.drawFrame(point37.f / 2 % fraImgSubEff.nFrame, point37.x, point37.y, Dir, 33, g);
					}
				}
				break;
			}
			...
			case 107:
			{
				...
				{
					Point point35 = (Point)VecEff.elementAt(num42);
			...
			case 110:
			{
				...
				{
					Point point34 = (Point)VecEff.elementAt(num40);
					if (point34.subType == 1)
					{
						fraImgSubEff.drawFrameNew(typeSub * 3 + point34.frame, point34.x, point34.y, 0, 3, g);
					}
					else
					{
						fraImgEff.drawFrameNew(typeSub * 4 + point34.frame, point34.x, point34.y, 0, 3, g);
					}
				}
				break;
			}
			case 115:
			{
				...
				{
					Point point33 = (Point)VecEff.elementAt(num39);
					fraImgEff.drawFrame(point33.frame, point33.x, point33.y, 0, 3, g);
				}
				break;
			}
			case 108:
			{
				...
				{
					Point point31 = (Point)VecEff.elementAt(num35);
					if (point31.dis != 0)
					{
			...
			case 60:
			{
				for (int num27 = 0; num27 < VecEff.size(); num27++)
				{
					...
					fraImgEff.drawFrame(point24.frame, point24.x, point24.y, 0, 3, g);
				}
				if (typeSub == 2)
				{
			...
			case 62:
			{
				...
				{
					Point point23 = (Point)VecEff.elementAt(num24);
					int num25 = point23.frame;
					if (f > fRemove - 4)
					{
						num25 += 3;
					}
					fraImgEff.drawFrame(num25, point23.x, point23.y, Dir, 3, g);
				}
				break;
			}
			case 66:
			{
				...
				fraImgEff.drawFrameNew(typeSub * 3 + num12, x, y, Dir, 3, g);
				break;
			}
			case 63:
				paintNo_Dat_New(g);
			...
			case 70:
			{
				...
				{
					Point point14 = (Point)VecEff.elementAt(num7);
					fraImgEff.drawFrame(point14.frame, objTo.x, objTo.y + point14.y, Dir, 33, g);
				}
				break;
			}
			case 83:
			{
				...
				for (int num = 0; num < VecEff.size(); num++)
				{
					Point point8 = (Point)VecEff.elementAt(num);
					fraImgEff.drawFrame(point8.frame, objTo.x, objTo.y + point8.y, Dir, 33, g);
				}
				break;
			}
			case 73:
			...
			case 154:
			{
				...
				for (int l = 0; l < VecEff.size(); l++)
				{
					...
					Point point5 = null;
					point5 = ((l >= VecEff.size() - 1) ? ((Point)VecEff.elementAt(0)) : ((Point)VecEff.elementAt(l + 1)));
			...
			case 155:
			{
				...
				for (int i = 0; i < VecEff.size(); i++)
				{
					...
					fraImgEff.drawFrameNew(point.f % 9 + f % fraImgEff.nFrame, point.x, point.y, 0, 3, g);
				}
				break;
			}
			case 75:
			case 78:
			{
				for (int num63 = 0; num63 < VecEff.size(); num63++)
				{
					...
					if (point51.frame == 0)
					{
						fraImgSubEff.drawFrame(point51.f % fraImgSubEff.nFrame, point51.x, point51.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrame(point51.f % fraImgSub2Eff.nFrame, point51.x, point51.y, 0, 3, g);
					}
				}
				if (f < fRemove + 10)
				{
			...
			case 76:
			{
				...
				{
					Point point48 = (Point)VecEff.elementAt(num59);
					if (point48.frame == 0)
					{
			...
			case 84:
			{
				for (int num51 = 0; num51 < VecEff.size(); num51++)
				{
					...
					fraImgEff.drawFrame(point41.frame, point41.x, point41.y, point41.dis, 3, g);
				}
				break;
			}
			case 85:
			{
				for (int num46 = 0; num46 < VecEff.size(); num46++)
				{
					...
					if (line.type < 4)
					{
						fraImgEff.drawFrame(line.f % fraImgEff.nFrame, line.x0 / 1000, line.y0 / 1000, 0, 3, g);
						continue;
					}
					if (line.type < 8)
					{
						fraImgSubEff.drawFrame(line.f % fraImgSubEff.nFrame, line.x0 / 1000, line.y0 / 1000, 0, 3, g);
						continue;
					}
					int color = 0;
			...
			case 31:
			{
				...
				{
					Point point27 = (Point)VecEff.elementAt(num31);
					if (point27.dis == 1)
					{
			...
			case 32:
			{
				...
				{
					Point point30 = (Point)VecEff.elementAt(num34);
					if (fraImgEff.nFrame != 0)
					{
						if (point30.dis == 1)
						{
							fraImgEff.drawFrameNew(fraImgEff.nFrame - point30.f / 2 % fraImgEff.nFrame, point30.x, point30.y, 0, 33, g);
						}
			...
			case 7:
			{
				...
				{
					Point_Focus point_Focus2 = (Point_Focus)VecEff.elementAt(num26);
			...
			case 93:
			{
				...
				{
					Point point22 = (Point)VecEff.elementAt(num23);
			...
			case 96:
			{
				...
				{
					Point_Focus point_Focus = (Point_Focus)VecEff.elementAt(num10);
			...
			case 98:
			{
				...
				{
					Point point11 = (Point)VecEff.elementAt(num4);
			...
			case 99:
			{
				...
				for (int n = 0; n < VecEff.size(); n++)
				{
					...
					fraImgSub2Eff.drawFrame(point7.f % 5, point7.x, point7.y, 0, 3, g);
				}
				break;
			}
			case 172:
			...
			case 101:
			{
				for (int j = 0; j < VecEff.size(); j++)
				{
					...
					if (objTo != null)
					{
						fraImgEff.drawFrame(point2.f, objTo.x + point2.x, objTo.y + point2.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 105:
			{
				for (int num62 = 0; num62 < VecEff.size(); num62++)
				{
					...
					fraImgEff.drawFrame(point50.frame, MainScreen.cameraMain.xCam + point50.x, point50.y, 0, 3, g);
				}
				break;
			}
			case 106:
			...
			case 111:
			{
				...
				{
					fraImgEff.drawFrame(0, x, y - num57 * fraImgEff.frameHeight + 5, CRes.random(2) * 2, 33, g);
				}
			...
			case 113:
			{
				for (int num54 = VecEff.size() - 1; num54 >= 0; num54--)
				{
					Point point44 = (Point)VecEff.elementAt(num54);
					fraImgSubEff.drawFrameNew(point44.frame * fraImgSubEff.maxNumFrame + point44.f / 3 % fraImgSubEff.maxNumFrame, point44.x / 1000, point44.y / 1000, 0, 33, g);
				}
			...
			case 116:
			{
				for (int num52 = 0; num52 < VecEff.size(); num52++)
				{
					...
					fraImgEff.drawFrame(point42.f % fraImgEff.nFrame, point42.x, point42.y, 0, 3, g);
				}
				break;
			}
			case 117:
			...
			case 119:
			{
				...
				{
					Point point39 = (Point)VecEff.elementAt(num48);
			...
			case 125:
			{
				...
				if (f < 3 || (f > 10 && f < 14))
				{
					num41 += CRes.random_Am_0(3);
				}
				fraImgEff.drawFrameNew(mPlayFrame[f], num41, y, 0, 33, g);
				break;
			}
			case 127:
			{
				...
				{
					fraImgEff.drawFrameNew(frame * 2 + f / 3 % 2, x, num38, 0, 3, g);
				}
				else
				{
					fraImgEff.drawFrameNew(frame * 2, x, num38, 0, 3, g);
				}
				break;
			}
			case 128:
			...
			case 130:
				if (objTo != null)
				{
					for (int num29 = 0; num29 < VecEff.size(); num29++)
					{
						...
						fraImgEff.drawFrameNew(point26.frame, objTo.x + point26.x, objTo.y + point26.y, 0, 33, g);
					}
				}
				break;
			case 131:
			...
			case 136:
				...
				{
					for (int num20 = 0; num20 < mPlayFrameVip[f].Length; num20++)
					{
						fraImgEff.drawFrameNew(mPlayFrameVip[f][num20], x, y, 0, 3, g);
					}
				}
				break;
			case 137:
			{
				...
				{
					Point point19 = (Point)VecEff.elementAt(num18);
					fraImgEff.drawFrame(point19.f / 4 % fraImgEff.nFrame, point19.x, point19.y, Dir, 33, g);
				}
				break;
			}
			case 139:
			...
			case 167:
			{
				...
				for (int num14 = 0; num14 < VecEff.size(); num14++)
				{
					...
					Point point18 = (Point)VecEff.elementAt(num15);
					if (point18.frame == 1)
					{
						if (f > fRemove - 2)
						{
						...
						if (typeEffect == 140)
						{
							fraImgEff.drawFrameNew(frame, point18.x, point18.y, 0, 33, g);
						}
						continue;
					}
					if (f > fRemove - 2)
					...
					fraImgSubEff.drawFrameNew(frame, point18.x + num16, point18.y + num17, 0, 33, g);
				}
				break;
			}
			case 146:
			{
				...
				{
					Point point17 = (Point)VecEff.elementAt(num11);
					fraImgEff.drawFrame(3 + point17.f % 3, point17.x / 1000, point17.y / 1000, Dir, 3, g);
				}
				break;
			}
			case 147:
			...
			case 153:
			{
				...
				{
					Point point16 = (Point)VecEff.elementAt(num9);
					if (CRes.random(2) == 0)
					{
						fraImgSub2Eff.drawFrameNew(CRes.random(4) + point16.frame * 4, point16.x, point16.y, Dir, 3, g);
					}
				}
				break;
			}
			...
			case 158:
			{
				...
				{
					Point point12 = (Point)VecEff.elementAt(num5);
					if (CRes.random(2) == 0)
					{
			...
			case 160:
			{
				...
				{
					Point point10 = (Point)VecEff.elementAt(num3);
					if (!point10.isRemove)
					{
			...
			case 161:
			{
				...
				for (int m = 0; m < VecEff.size(); m++)
				{
					...
					fraImgEff.drawFrameNew(typeSub * fraImgEff.maxNumFrame + point6.frame, point6.x / 100, point6.y / 100, 0, 3, g);
				}
				break;
			}
			case 162:
	...
	public override void update()
	{
		...
		case 6:
			if (typeSub == 3)
			{
				for (int num14 = 0; num14 < VecEff.size(); num14++)
				{
					Point point20 = (Point)VecEff.elementAt(num14);
					point20.f++;
					if (point20.f >= fraImgSub2Eff.maxNumFrame)
					{
		...
		case 47:
		{
			...
			{
				Point point35 = (Point)VecEff.elementAt(num38);
				point35.update();
		...
		case 120:
		{
			for (int num49 = 0; num49 < VecEff.size(); num49++)
			{
				Point point44 = (Point)VecEff.elementAt(num49);
				point44.update();
				point44.vy++;
			}
			if (f >= fRemove)
		...
		case 107:
		{
			for (int num52 = 0; num52 < VecEff.size(); num52++)
			{
				Point point46 = (Point)VecEff.elementAt(num52);
				point46.update();
			}
			if (f >= fRemove)
			{
		...
		case 108:
		{
			for (int num46 = 0; num46 < VecEff.size(); num46++)
			{
				Point point41 = (Point)VecEff.elementAt(num46);
				if (point41.f % 2 == 0)
				{
					point41.vy++;
				}
		...
		case 83:
		{
			...
			{
				Point point19 = (Point)VecEff.elementAt(num13);
				if ((point19.vy > 0 && point19.y >= 0) || (point19.vy < 0 && point19.y <= -30))
				{
					point19.vy = -point19.vy;
				}
		...
		case 70:
		{
			for (int num5 = 0; num5 < VecEff.size(); num5++)
			{
				...
				if ((point10.vy > 0 && point10.y >= 0) || (point10.vy < 0 && point10.y <= -30))
				{
					point10.vy = -point10.vy;
				}
		...
		case 155:
		{
			for (int num51 = 0; num51 < VecEff.size(); num51++)
			{
				Point point45 = (Point)VecEff.elementAt(num51);
				point45.x = CRes.getcos(CRes.fixangle(point45.dis)) * vMax / 1000 + x;
				point45.y = CRes.getsin(CRes.fixangle(point45.dis)) * vMax / 1000 + y;
				point45.dis += 30;
			}
			vMax -= 2;
			if (f >= fRemove)
		...
		case 78:
		{
			...
			if (typeSub != 1 && f < fRemove + 10)
			{
				...
				{
					Point point21 = new Point(x + CRes.random_Am_0(4), y + CRes.random_Am_0(4));
					point21.frame = CRes.random(3);
					point21.vy = -1 + CRes.random(3);
					point21.vx = CRes.random_Am_0(2);
					point21.fRe = 8 + CRes.random(4);
					VecEff.addElement(point21);
				}
			}
			for (int num20 = 0; num20 < VecEff.size(); num20++)
			{
				Point point22 = (Point)VecEff.elementAt(num20);
				point22.update();
				point22.vy++;
				if (point22.f >= point22.fRe)
				{
		...
		case 76:
		{
			for (int num29 = 0; num29 < VecEff.size(); num29++)
			{
				Point point27 = (Point)VecEff.elementAt(num29);
				point27.update();
				if (point27.f >= point27.fRe)
				{
		...
		case 84:
		{
			for (int num3 = 0; num3 < VecEff.size(); num3++)
			{
				...
				{
					if (point9.f - point9.fRe == 2)
					{
						point9.frame = 2;
					}
					if (point9.f - point9.fRe == 4)
					{
						point9.frame = 3;
					}
					if (point9.f - point9.fRe == 6)
					{
		...
		case 31:
		{
			...
			for (int num42 = 0; num42 < VecEff.size(); num42++)
			{
				Point point37 = (Point)VecEff.elementAt(num42);
				point37.update();
				if (point37.dis == 1)
				{
					point37.vy = vy;
			...
			if (f < 10 && f % 3 == 2)
			{
				...
				{
					Point point38 = new Point(x + CRes.random_Am_0(20), y - CRes.random(30) + 10);
					point38.vy = -2 - CRes.random(4);
					point38.dis = 0;
					point38.frame = CRes.random(fraImgSubEff.nFrame);
					point38.fRe = CRes.random(12, 20);
		...
		case 32:
		{
			...
			if (f < fRemove && (f % 3 == 2 || f < 3))
			{
				...
				{
					Point point11 = new Point(x + CRes.random_Am_0(20), y + CRes.random(30) - 72);
					point11.vy = 2 + CRes.random(4);
					point11.dis = 0;
					point11.frame = CRes.random(fraImgSubEff.nFrame);
					point11.fRe = CRes.random(12, 20);
			...
			for (int num7 = 0; num7 < VecEff.size(); num7++)
			{
				...
				if (point12.f >= point12.fRe)
				{
					VecEff.removeElement(point12);
					num7--;
				}
			}
			if (f >= fRemove && VecEff.size() == 0)
		...
		case 7:
		{
			for (int num39 = 0; num39 < VecEff.size(); num39++)
			{
				Point_Focus point_Focus3 = (Point_Focus)VecEff.elementAt(num39);
				point_Focus3.update_Vx_Vy();
				if (point_Focus3.f >= point_Focus3.fRe)
				{
					VecEff.removeElement(point_Focus3);
					LoginScreen.addEffectEnd(1, 0, point_Focus3.toX, point_Focus3.toY, Dir, objMainEff);
					num39--;
				}
			}
		...
		case 93:
		{
			for (int num32 = 0; num32 < VecEff.size(); num32++)
			{
				Point point31 = (Point)VecEff.elementAt(num32);
				point31.update();
				point31.vy++;
				if (point31.f >= point31.fRe)
				{
					VecEff.removeElement(point31);
					num32--;
				}
			}
		...
		case 95:
		{
			for (int num30 = 0; num30 < VecEff.size(); num30++)
			{
				Point point28 = (Point)VecEff.elementAt(num30);
				point28.update();
				if (point28.y < point28.y2 - 60)
				{
					point28.y = point28.y2;
				}
			}
			break;
		}
		case 96:
		{
			...
			{
				Point_Focus point_Focus2 = (Point_Focus)VecEff.elementAt(num16);
				for (int num17 = 0; num17 < 3; num17++)
				{
					GameScreen.addEffectEnd(4, 0, point_Focus2.x - 20 + 20 * num17, point_Focus2.y - 20 + num17 % 2 * 20, Dir, objMainEff);
				}
			}
			VecEff.removeAllElements();
			removeEff();
		...
		case 104:
		{
			if (f == 3 || f == 6)
			{
				...
				for (int k = 0; k < num; k++)
				{
					Point point3 = new Point(x + CRes.random_Am_0(20), y + CRes.random_Am_0(10));
					point3.fRe = CRes.random(8, 11);
					point3.vy = -CRes.random(5, 7);
					VecEff.addElement(point3);
				}
			}
			for (int l = 0; l < VecEff.size(); l++)
		...
		case 111:
		{
			...
			for (int num47 = 0; num47 < VecEff.size(); num47++)
			{
				Point point42 = (Point)VecEff.elementAt(num47);
				point42.update();
				if (point42.y < -210)
				{
			...
			if (f % 2 == 1)
			{
				...
				{
					Point point43 = new Point(CRes.random_Am_0(20), -5 + CRes.random(10));
					point43.vy = -CRes.random(12, 20);
					point43.frame = CRes.random(fraImgSubEff.nFrame);
					VecEff.addElement(point43);
				}
			}
			if (f >= fRemove)
			{
		...
		case 113:
		{
			...
			if (f < 8)
			{
				...
				for (int num25 = 0; num25 < num22; num25++)
				{
					...
					point23.x = x * 1000 + CRes.getcos(CRes.fixangle(num24 + num21 * num25) + f * 5) * f * vMax;
					point23.y = y * 1000 + CRes.getsin(CRes.fixangle(num24 + num21 * num25) + f * 5) * f * (vMax - 4);
					point23.dis = f % 1;
					point23.fSmall = 1;
					if (typeSub == 2)
					{
			...
			for (int num26 = 0; num26 < VecEff.size(); num26++)
			{
				...
				if (point24.f == 1)
				{
					if (point24.dis == 0)
					{
						int tile2 = GameCanvas.loadmap.getTile(point24.x / 1000, point24.y / 1000);
						if (tile2 == 0 || tile2 == 2)
						{
							GameScreen.addEffectEnd(66, (point24.frame != 1) ? 1 : 0, point24.x / 1000, point24.y / 1000, Dir, objMainEff);
						}
						else
						{
							point24.isRemove = true;
						}
					}
					if (CRes.random(6) == 0)
					{
						GameScreen.addEffectEnd(110, (point24.frame != 1) ? 1 : 0, point24.x / 1000, point24.y / 1000, Dir, objMainEff);
					}
				}
				if (point24.f / 3 >= fraImgSubEff.maxNumFrame || point24.isRemove)
				{
		...
		case 116:
		{
			...
			if (f % 5 == 1 && f < fRemove && CRes.random(2) == 0)
			{
				...
				point14.x = x + CRes.random_Am_0(10);
				point14.y = y + CRes.random(20);
				point14.vx = CRes.random_Am_0(3);
				point14.vy = -CRes.random(3, 7);
				point14.fRe = CRes.random(12, 18);
				VecEff.addElement(point14);
			}
			if (f % 4 == 1 && f < fRemove)
			{
				Point point15 = new Point();
				point15.x = x + CRes.random_Am_0(15);
				point15.y = y + CRes.random(20);
				point15.vx = CRes.random_Am_0(3);
				point15.vy = -CRes.random(3, 7);
				point15.fRe = CRes.random(4, 7);
		...
		case 126:
		{
			for (int num50 = 0; num50 < VecEff.size(); num50++)
			{
				Point_Focus point_Focus4 = (Point_Focus)VecEff.elementAt(num50);
				point_Focus4.update_Vx_Vy();
				if (point_Focus4.f >= point_Focus4.fRe)
				{
			...
			{
				step = 3;
				Point_Focus point_Focus5 = new Point_Focus();
				point_Focus5.frame = 1;
				point_Focus5.fRe = 8;
				point_Focus5.x = x / 100;
				point_Focus5.y = y / 100;
				point_Focus5.vy = -4;
				VecEff.addElement(point_Focus5);
			...
			if (step == 1)
			{
				...
				if (frame == 8)
				{
					...
					Point_Focus point_Focus6 = new Point_Focus();
					int xdich = x / 100 - x1000;
					int ydich = y / 100 - y1000;
					point_Focus6.frame = 0;
					create_Speed(xdich, ydich, point_Focus6, x1000, y1000, x / 100, y / 100);
					VecEff.addElement(point_Focus6);
		...
		case 130:
		{
			for (int num44 = 0; num44 < VecEff.size(); num44++)
			{
				Point point39 = (Point)VecEff.elementAt(num44);
				point39.x += point39.vx;
				point39.y += point39.vy;
				if (point39.y <= -60)
				{
			...
			if (f % 10 == 0)
			{
				for (int num45 = 0; num45 < 5; num45++)
				{
					...
					point40.x = CRes.random_Am_0(15);
					point40.y = 10 - CRes.random(40);
					point40.dis = 1 + CRes.random(3);
					point40.vy = -4;
					point40.frame = CRes.random(12);
					VecEff.addElement(point40);
				}
			}
			if ((GameCanvas.timeNow - time) / 1000 >= timeRemove || objTo == null)
			{
		...
		case 137:
		{
			for (int num31 = 0; num31 < VecEff.size(); num31++)
			{
				Point point30 = (Point)VecEff.elementAt(num31);
				point30.x += vx;
				point30.f++;
		...
		case 167:
		{
			for (int num27 = 0; num27 < VecEff.size(); num27++)
			{
				Point point25 = (Point)VecEff.elementAt(num27);
				if (CRes.random(3) == 0)
				{
					point25.x = x + CRes.random_Am_0(3);
					point25.y = y + CRes.random_Am_0(3);
				}
			}
			if (f >= fRemove)
			{
		...
		case 146:
		{
			for (int num28 = 0; num28 < VecEff.size(); num28++)
			{
				Point point26 = (Point)VecEff.elementAt(num28);
				point26.update();
			}
			if (f >= fRemove)
			{
		...
		case 153:
		{
			...
			if (f >= 140 && f <= 180)
			{
				for (int j = 0; j < MotherCanvas.w / 10 - 1; j++)
				{
					if (CRes.random(4) == 0)
					{
						Point point2 = new Point(MainScreen.cameraMain.xCam + 5 + j * 10 + CRes.random(3), y);
						point2.vy = 5;
						point2.vx = CRes.random_Am_0(2);
						point2.fRe = MotherCanvas.h / 5 + CRes.random_Am_0(10);
						point2.frame = CRes.random(9);
						VecEff.addElement(point2);
					}
				}
			}
		...
		case 158:
		{
			...
			for (int num34 = 0; num34 < VecEff.size(); num34++)
			{
				Point point33 = (Point)VecEff.elementAt(num34);
				point33.update();
				if (point33.x < MainScreen.cameraMain.xCam)
				{
					point33.x += MotherCanvas.w;
				}
				else if (point33.x > MainScreen.cameraMain.xCam + MotherCanvas.w)
				{
					point33.x -= MotherCanvas.w;
				}
			...
			if (f >= 40 && f <= 90)
			{
				for (int num37 = 0; num37 < MotherCanvas.w / 10 - 1; num37++)
				{
					if (CRes.random(4) == 0)
					{
						Point point34 = new Point(MainScreen.cameraMain.xCam + 5 + num37 * 10 + CRes.random(3), MainScreen.cameraMain.yCam - 10);
						point34.vy = 5;
						point34.vx = CRes.random_Am_0(2);
						point34.fRe = MotherCanvas.h / 5 + CRes.random_Am_0(10);
						point34.frame = CRes.random(9);
		...
		case 160:
		{
			for (int num33 = 0; num33 < VecEff.size(); num33++)
			{
				Point point32 = (Point)VecEff.elementAt(num33);
				point32.x += point32.vx;
				point32.y += point32.vy;
				if (f < 6 || f > 12)
				{
					point32.vy = -1;
				}
				...
				if (f > 10)
				{
					...
					{
						point32.isRemove = true;
					}
					else
					{
						point32.frame = 2 + CRes.random(2);
					}
				}
		...
		case 161:
		{
			for (int num10 = 0; num10 < VecEff.size(); num10++)
			{
				Point point17 = (Point)VecEff.elementAt(num10);
				point17.update();
				if (point17.f >= point17.fRe)
				{
			...
			if (f == 20 + lengthM - randomf)
			{
				...
				for (int num12 = 0; num12 < num11; num12++)
				{
					...
					point18.x = x * 100 + CRes.random_Am_0(200);
					point18.y = y * 100 + CRes.random_Am_0(200);
					point18.vx = CRes.random_Am_0(200);
					point18.vy = CRes.random_Am_0(200);
					point18.frame = 2 + CRes.random(2);
					point18.fRe = 6 + CRes.random(3);
